# **SEO Content Writer Skill Generator Prompt**

Use this prompt to create your own personalized SEO content writer skill. Fill in the variables marked with `[BRACKETS]` and provide the required files.
...
1. **Tone of Voice Document** \- Your writing style guide (txt or md format)  
2. **Sitemap CSV** \- Your website's pages (must include: Link, Title, Description columns)  
3. **Experiences Document** \- Your client wins, case studies, or success stories (md format)

### **Step 3: Send to Claude**

In a conversation with Claude:

1. Paste your filled-out prompt  
2. Upload all three files  
3. Claude will use the skill-creator to build your custom SEO writer skill
...
### **For Tone of Voice Document:**

* Include 5-10 example sentences in your voice  
* List specific phrases you use frequently  
* List phrases you never use  
* Include examples of transitions you prefer  
* Note any industry-specific terminology preferences

### **For Sitemap CSV:**

* Ensure URLs are complete (including https://)  
* Include descriptive page titles (not just "Home" or "About")  
* Add meaningful meta descriptions that indicate page content  
* Keep it current \- outdated pages lead to irrelevant internal links

### **For Experiences Document:**

* Include specific metrics (e.g., "increased traffic by 150%")  
* Mention the strategy/tactic used  
* Include timeframes (e.g., "within 3 months")  
* Organize by topic/category if you have many examples  
* Add tags or keywords to each story for easier matching

### **For Variables:**

* **Be specific with Target Audience** \- "small business owners" is vague; "solo financial advisors with \<$500K AUM" is better  
* **List Primary Topics** \- Include 3-7 main content themes you write about  
* **SEO Vocabulary** \- Include 10-15 terms you want emphasized in your content  
* **Tone Characteristics** \- Use adjectives and examples, not just "professional"

If you want to learn how to rank in AI Search using ai tools like this 👉🏼 [https://www.skool.com/ai-ranking](https://www.skool.com/ai-ranking)  
